...
function App() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#e8e4dc] font-['IBM_Plex_Mono',monospace] overflow-x-hidden">
      ...
      {/* Hero */}
      <main className="relative z-10 px-8 pt-24 pb-16 max-w-5xl mx-auto">
        {/* Overline */}
        ...
        {/* About cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#e8e4dc]/10">
          {[
            {
              label: "Background",
      ...
      {/* Footer */}
      <footer className="relative z-10 px-8 py-8 border-t border-[#e8e4dc]/10 flex items-center justify-between">
